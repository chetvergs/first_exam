...
# Пример:
#
# a, b = func((1,2,3,4,5)) print(a) #[2, 4] print(b) #[1, 4, 9, 16, 25]Создать телеграм-бота, который считывает входящие сообщения и выдает сколько раз повторяются в этом сообщении гласные буквы. Для простоты считайте, что все сообщения будут присылаться на латинице. Не забывайте, что гласные буквы могут быть в верхнем регистре
#
# Пример: